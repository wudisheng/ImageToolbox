...
android {
    ...
    defaultConfig {
        ...
        applicationId = "ru.tech.imageresizershrinker.rename02"
    ...
    buildTypes {
        debug {
            ...
            resValue("string", "app_launcher_name", "Image Toolbox R2 DEBUG")
            resValue("string", "file_provider", "com.t8rin.imagetoolbox.fileprovider.rename02.debug")
        }
        release {
            ...
            resValue("string", "app_launcher_name", "Image Toolbox R2")
            resValue("string", "file_provider", "com.t8rin.imagetoolbox.fileprovider.rename02")
        }
        create("benchmark") {

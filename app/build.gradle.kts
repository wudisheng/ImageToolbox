...
android {
    ...
    buildTypes {
        debug {
            ...
            resValue("string", "file_provider", "com.t8rin.imagetoolbox.fileprovider.rename03.debug")
        }
        release {
            ...
            resValue("string", "file_provider", "com.t8rin.imagetoolbox.fileprovider.rename03")
        }
        create("benchmark") {
